...
function MyGraphLeaf(graph, xmlelem) {
    ...
    this.args = this.graph.reader.getString(this.element, 'args').split(" ").map(function (a) { parseFloat(a) });
    this.primitive = null;
    ...
    if (this.type == "rectangle") {
        ...
        this.primitive = new Sphere(this.graph.scene, this.args[0], this.args[1], this.args[2], this.args[3], this.args[4], this.args[5], this.args[6], this.args[7], this.args[8]);
    } else if (this.type == "sphere") {
        this.primitive = new Sphere(this.graph.scene, this.args[0], this.args[1], this.args[2], this.args[3], this.args[4], this.args[5], this.args[6], this.args[7], this.args[8]);
    }
    */
